...
**How REV works (in brief).** REV is a vacuum-microwave dehydration process: a vacuum lowers water's boiling point so moisture leaves at near-room temperature without cooking or oxidizing the food, while microwaves heat it volumetrically from the inside out. The payoff is **freeze-dried-like quality at a fraction of the cost and time** — roughly 30–40-minute batches versus ~24–30 hours for freeze-drying, at ~85–90% energy efficiency and ~95% nutrient/color retention — which is the technical basis for the margin structure this thesis hinges on. The platform is licensed from EnWave and validated well beyond food (Merck has cited REV as a faster alternative to vial lyophilization for biologics), which is precisely why the durable moat rests on the Peru cost base and exclusivity rather than the machine itself.
...
Notably, the leadership has executed this kind of playbook before: founder-CEO Eric Healy previously built and sold a national CPG brand (the No-Bake Cookie Company) to private equity and hails from the family behind Kettle Brand chips and Kona Brewing, while CCO Joshua O'Brien helped scale Amplify's SkinnyPop — acquired by Hershey for ~$1.6B — and held senior roles at Kraft Heinz, giving the team first-hand experience with the exact better-for-you-snack scale-and-sell path BOF is now running.
